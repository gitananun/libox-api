                    ...
                    <div class="info_wrapper">
                        <div class="contact_info">
                            <ul class="list-unstyled">
                                ...
                                <li><i class="flaticon-mail-black-envelope-symbol"></i>contact@yourdomain.com
                                </li>
                            </ul>
                        </div>
            ...
            <nav class="navbar navbar-expand-md navbar-light bg-faded">
                    ...
                    <ul class="navbar-nav nav lavalamp ml-auto menu">
                        <li class="nav-item"><a href="#" class="nav-link active">Home</a>
                            <ul class="navbar-nav nav mx-auto">
                                ...
                                <li class="nav-item"><a href="index-3.html" class="nav-link">Home
                                        Version 02</a>
                                </li>
                                <li class="nav-item"><a href="index-4.html" class="nav-link">Home
                                        Version 03</a>
                                </li>
                                <li class="nav-item"><a href="index-5.html" class="nav-link">Home
                                        Version 04</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item"><a href="blog.html" class="nav-link">Blog</a>
                            <ul class="navbar-nav nav mx-auto">
                                ...
                                <li class="nav-item"><a href="blog-2.html" class="nav-link">Blog
                                        Grid
                                        One</a></li>
                                <li class="nav-item"><a href="blog-3.html" class="nav-link">Blog
                                        Grid
                                        Two</a></li>
                            ...
                            <ul class="navbar-nav nav mx-auto">
                                <li class="nav-item"><a href="#" class="nav-link dropdown_icon">Courses</a>
                                    <ul class="navbar-nav nav mx-auto">
                                        ...
                                        <li class="nav-item"><a href="course-details.html"
                                ...
                                <li class="nav-item"><a href="#" class="nav-link dropdown_icon">Events</a>
                                    <ul class="navbar-nav nav mx-auto">
                                        ...
                                        <li class="nav-item"><a href="event-details.html"
                                ...
                                <li class="nav-item"><a href="become-a-teacher.html" class="nav-link">Become
                                        A
                                        Teacher</a></li>
                                <li class="nav-item"><a href="teacher-profile.html"
                                        class="nav-link">Teachers
                                        Profile</a></li>
                                <li class="nav-item"><a href="team.html" class="nav-link">Teachers
                                        Page</a></li>
                ...
                <div class="mr-auto search_area ">
                    <ul class="navbar-nav mx-auto d-flex">
                        ...
                        <li class="nav-item cart_icon"><i class="flaticon-shopping-bag">
                                <p>2</p>
                            </i>
                            <div class="cart_list">
                                <div class="single_cart d-flex justify-content-between">
                                    <div class="cart_banner">
                                        <a href="#"><img alt="" src="images/courses/courses_1.jpg"
                                                class="img-fluid"></a>
                                    </div>
                                    <div class="cart_info">
                                ...
                                <div class="single_cart d-flex justify-content-between">
                                    <div class="cart_banner">
                                        <a href="#"><img alt="" src="images/courses/courses_2.jpg"
                                                class="img-fluid"></a>
                                    </div>
                                    <div class="cart_info">
                                ...
                                <div class="cart_calculate_wrapper">
                                    <div class="calculate_price"><span>Sub-Total :</span><span>$300.00</span>
                                    </div>
                                    <div class="calculate_price"><span>Eco Tax (-2.00)
                                            :</span><span>$5.00</span>
                                    </div>
                                    <div class="calculate_price"><span>VAT (20%) :</span><span>$25.00</span>
                                    </div>
                                    <div class="calculate_price"><span>Total </span><span
                                            class="total_price">$330.00</span></div>
                                </div>
